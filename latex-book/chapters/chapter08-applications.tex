...
This chapter showcases real-world applications of genetic algorithms, directly from the course materials, demonstrating how GA concepts are applied in practice~\cite{gen2007genetic, sivanandam2008introduction, eiben2015introduction}.
...
\item \textbf{Mutation}: Random button variations to explore new strategies~\cite{montana1989training, koza1992genetic}
\end{itemize}
...
\item \textbf{Encoding}: Sequence of movement directions (up, down, left, right)~\cite{larranaga1999genetic}
...
\item Multi-objective fitness (speed, stability, efficiency)~\cite{deb2001multi, deb2002fast, horn1994niched}
\end{itemize}
